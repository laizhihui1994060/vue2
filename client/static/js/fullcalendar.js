...
DayGrid.mixin({
	...
	fgSegHtml: function(seg, disableResizing) {
		...
		titleHtml =
			'<span class="fc-title"><span class="event-decoration"></span>' +
...
var View = FC.View = Class.extend(EmitterMixin, ListenerMixin, {
	...
	buildGotoAnchorHtml: function(gotoOptions, attrs, innerHtml) {
		...
		if (!forceOff && this.opt('navLinks')) {
			...
			var tmpHtml= '<div' + attrs + '><span class=\'date-num\'>' +
				innerHtml +
				'</span>';
				if(attrs.match("fc-day-number")){
					tmpHtml+="日";
				}
				tmpHtml+="</div>";
				return tmpHtml;
