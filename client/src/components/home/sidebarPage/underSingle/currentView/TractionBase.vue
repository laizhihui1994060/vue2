<template>
    <div class="content" id="TractionBase">
        <div class="body clearfix">
            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <div class="inline">
                        <form-label-input @updata="integrationDate" input-width="145px" type="number" name="carOwnerPhone" placeholder="车主电话" verify="1" :value="orderItem.vehicles.carOwnerPhone"/>
                    </div>
                </div>
            </div> 
            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <div class="inline">
                        <form-label-input @updata="integrationDate" input-width="145px" type="number" name="callPersonContact" placeholder="委派人电话" :value="orderItem.order.callPersonContact"/>
                    </div>
                </div>
            </div> 
