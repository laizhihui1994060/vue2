<template>
    <div id='mineInvited' class="modal fade">
        <div class="modal-dialog" >
            <div class="modal-content" v-if='tableShow'>
				...
				<vue-table
				    ...
				    item-url="client:/partnerinvitation/list/invitation"
				    type='post'
				    :params='params'
				    :isTime='false'
				    :historySearch='false'
...
<script>
	...
	export default{
		components:{
	    	...
	    	data () {
	         return {
	             ...
	             tableIterationField:[
	                 {
	                     tr:'公司名称',
	                     field:'invitedOrgInfo.name',
	                     filter: 'obj'
	                 },
	                 {
	                     tr:'联系人',
	                     field:'invitedOrgInfo.empName',
	                     filter: 'obj'
	                 },
	                 {
	                     tr:'联系电话',
	                     field:'invitedOrgInfo.chargePersonPhone',
	                     filter: 'obj',
	                 },
	                 {
	                     tr:'状态',
	     ...
	     mounted(){
	     		const _this = this;
	     		$("#mineInvited").on("shown.bs.modal",function(){
...
<style>
	#mineInvited .modal-dialog{
		width: 700px;
	}
	#mineInvited .right_content{
		min-height: auto;
	}
	.close{
		opacity:0.5;
